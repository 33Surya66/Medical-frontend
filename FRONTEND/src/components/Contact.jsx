      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/3 bg-gradient-to-b from-blue-600 to-teal-500 p-6 text-white">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">contact@healthfactfinder.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">San Francisco, CA 94103</p>
                  </div>
                </div>
              </div>
            ...
            <div className="md:w-2/3 p-6">
              ...
              {formStatus.submitted && (
                <div className={`mb-4 p-3 rounded-md ${formStatus.success ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                  {formStatus.message}
                </div>
              )}
